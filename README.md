...
I would also like to mention mozilla. Mozilla is the custodian of the Mozilla Public License ("MPL"), an open source/free software license. Since it is an open source, anyone can access the source code and help on improving it. Here is the link to the mozilla source code: https://developer.mozilla.org/en-US/docs/Developer_Guide/Source_Code. This link provedes assess to the source code, furthermore it provides a documentation on how to get started on improving the mozilla. 
...
i would also like to mention mozilla. Mozilla is the custodian of the Mozilla Public License ("MPL"), an open source/free software license. Since it is an open source, anyone can access the source code and help on improving it. Here is the link to the mozilla source code: https://developer.mozilla.org/en-US/docs/Developer_Guide/Source_Code. This link provides  assess to the source code, furthermore it provides a documentation on how to get started on improving the mozilla.
